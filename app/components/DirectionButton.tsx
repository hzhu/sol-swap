  ...
  return (
    <button
      ...
      className={clsx(
        ...
        props.disabled ? "" : "hover:bg-purple-800/75 active:bg-purple-800/50",
        "rounded-sm transition-all duration-200 bg-purple-800 disabled:text-slate-100 disabled:opacity-50",
        className
      )}
      onClick={(e) => {
